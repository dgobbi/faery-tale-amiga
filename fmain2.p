...
int ppick(void);
int print(char *str);
int print_cont(char *str);
int extract(char *start);
int announce_container(char *s);
int announce_treasure(char *s);
int name(void);
...
int load_next(void);
int read_score(void);
int copypage(char *br1, char *br2, int x, int y);
int flipscan(void);
int skipint(void);
...
int saveload(char *buffer, long length);
